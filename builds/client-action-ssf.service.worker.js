...
const CACHE_NAME = "client-action-ssf-cache";
const OFFLINE_URL = "client-action-ssf.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["client-action-ssf.html","client-action-ssf.js","client-action-ssf.wasm","client-action-ssf.pck","client-action-ssf.offline.html","client-action-ssf.icon.png","client-action-ssf.apple-touch-icon.png"];
